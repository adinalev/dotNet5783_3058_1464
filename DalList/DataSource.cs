...
internal static class DataSource
{
    ...
    private static void PushOrderItems()
    {
        for (int i = 0; i < 40; i++)
        {
            ...
            Order ord = orderList[rand.Next(orderList.Count)];
            orderItemList.Add(
                new OrderItem
                {
                   // ID = 0,
                    ...
                    OrderID = ord.ID, // CHANGED THIS AND PROBABLY NOT CORRECT!!!!
                    Price = prod.Price,
...
//internal static class DataSource // should be internal static
//{
//    readonly static Random rand = new Random(); // readonly static field for generating random numbers
